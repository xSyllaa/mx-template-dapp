-- Fix leaderboard functions to include ALL points (positive and negative)
-- This matches the original logic where betting losses are negative points
...
-- Create get_leaderboard function that includes all points
...
-- Create get_user_rank function that includes all points
...
BEGIN
    ...
    -- Get user's total points for the period (including negative amounts)
